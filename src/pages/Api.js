    ...
    <>
      <div className="api">
        <article>
          ...
          <p>
            The API and site will always remain free at point of access. If you
            love our service and want extra features you can sign up as a{" "}
            <Link
            ...
            for $2.
            <br /> You can cancel anytime. This allows us to pay for the servers
            and bandwidth and develop new features.
          </p>
        </article>
        <article>
          <h5>
          ...
          <p>
            ...
            for educational use(see test links below) However you must apply for
            a key a production API key via email if releasing publicly on an
            appstore. The test key may be revoked at any time if abused.
          </p>
        </article>
        <article>
          <h5>
...
"
          ...
          <p>
            ...
            ingredient filters. You also get access to adding your own meals and
            images. You can also list the full database rather than limited to
            100 items. Please{" "}
            <Link
              to={{ pathname: "https://www.patreon.com/thedatadb" }}
              target="_blank"
        ...
        <article className="italic">
          ...
          <p className="purp">www.themealdb.com/api/json/v1/1/search.php?f=a</p>
          ...
          <p className="purp">www.themealdb.com/api/json/v1/1/categories.php</p>
        ...
        <article>
          ...
          <p className="purp">www.themealdb.com/images/ingredients/Lime.png</p>
          <p className="purp">
